...
using AFE = Amalay.FoodOrder.Enumerations;

namespace Amalay.FoodOrder.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> GuestLogin(GuestViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case AFE.SignInStatus.Success:
                    return RedirectToLocal(returnUrl);
                case AFE.SignInStatus.LockedOut:
                    return View("Lockout");
                case AFE.SignInStatus.RequiresTwoFactorAuthentication:
                    return RedirectToAction("SendCode", new { ReturnUrl = returnUrl });
                case AFE.SignInStatus.Failure:
                default:
