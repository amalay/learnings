...
using System.Web;
using Amalay.FoodOrder.Enumerations;
...
namespace Amalay.FoodOrder.Models
{
    public class SignInHelper
    {
        ...
        public async Task<SignInStatus> ExternalSignIn(Microsoft.AspNet.Identity.Owin.ExternalLoginInfo loginInfo, bool isPersistent)
        {
