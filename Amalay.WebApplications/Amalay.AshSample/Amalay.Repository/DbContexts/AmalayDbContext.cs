...
{
    public class AmalayDbContext : DbContext
    {

        public AmalayDbContext() : base("Name=AmalayDbContext")
        {
        ...
        public System.Data.Entity.DbSet<Amalay.Model.ProductViewModel> ProductViewModels { get; set; }
    }
}
